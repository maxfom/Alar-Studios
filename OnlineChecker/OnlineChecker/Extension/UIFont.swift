...
extension UIFont {
    ...
    static func AvenirNext18() -> UIFont? {
        return UIFont.init(name: "Avenir Next", size: 18)
    }
    ...
    static func AvenirNext12() -> UIFont? {
        return UIFont.init(name: "Avenir Next", size: 12)
    }
    ...
    static func AvenirNextDemiBold18() -> UIFont? {
        return UIFont.init(name: "Avenir Next Demi Bold", size: 18)
    }
    
    static func AvenirNextDemiBold16() -> UIFont? {
        return UIFont.init(name: "Avenir Next Demi Bold", size: 16)
    }
    ...
    static func AvenirNextDemiBold12() -> UIFont? {
        return UIFont.init(name: "Avenir Next Demi Bold", size: 12)
    }
